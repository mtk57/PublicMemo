...
Public Const DEBUG_LOG_CELL = "D14"

Public Const COMMON_PARAM_CLM = "D"
Public Const COMMON_PARAM_ROW = 12
Public Const COMMON_PARAM_ROWS = 3

Public Const GIT_PARAM_CLM = "D"
Public Const GIT_PARAM_ROW = 17
Public Const GIT_PARAM_ROWS = 3
...
Public Const TARGET_PARAM_ROW = 23
